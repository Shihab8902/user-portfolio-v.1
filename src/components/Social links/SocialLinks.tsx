    ...
    return <div className="container mx-auto px-5 my-20 flex md:items-center justify-between gap-10 lg:gap-0 flex-wrap flex-col md:flex-row">
        ...
        <div className="flex gap-4">
            ...
            <div>
                ...
                <Link to="https://www.linkedin.com/in/atm-mahmud-95570333" className="flex items-center gap-2 mt-1 text-[#C58940] text-lg " target="_blank">Follow<IoIosArrowRoundForward className="text-2xl" /> </Link>
            </div>
        </div>
        ...
        <div className="flex gap-4">
            ...
            <div>
                ...
                <Link to="https://www.facebook.com/founder.atms" className="flex items-center gap-2 mt-1 text-[#C58940] text-lg " target="_blank">Follow<IoIosArrowRoundForward className="text-2xl" /> </Link>
            </div>
        </div>
        ...
        <div className="flex gap-4">
            ...
            <div>
                ...
                <Link to="https://www.instagram.com/atmmahmud/" className="flex items-center gap-2 mt-1 text-[#C58940] text-lg" target="_blank" >Follow <IoIosArrowRoundForward className="text-2xl" /> </Link>
            </div>
        </div>
        ...
        <div className="flex gap-4">
            ...
            <div>
                ...
                <Link to="https://twitter.com/atmmahmud1" className="flex items-center gap-2 mt-1 text-[#C58940] text-lg" target="_blank" >Follow <IoIosArrowRoundForward className="text-2xl" /> </Link>
            </div>
        </div>
        ...
        <div className="flex gap-4">
            ...
            <div>
                ...
                <Link to="https://bn.quora.com/profile/ATM-Sir-3" className="flex items-center gap-2 mt-1 text-[#C58940] text-lg" target="_blank" >Follow <IoIosArrowRoundForward className="text-2xl" /> </Link>
            </div>
        </div>
